    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 overflow-hidden">
        <div className="min-h-screen px-4 py-8 text-center flex items-center justify-center">
          ...
          {/* Modal container */}
          <motion.div
            className="relative z-10 inline-block bg-white rounded-3xl shadow-2xl max-w-md w-full text-left transform transition-all"
          ...
          >
            ...
            >
              ...
              <div className="bg-gradient-to-r from-pink-600 to-pink-400 px-6 py-4 flex items-center justify-between flex-shrink-0 rounded-t-3xl">
              ...
              {/* Stats bar - fixed below search */}
              <div className="px-6 py-3 bg-pink-50/50 border-b border-gray-100 flex-shrink-0">
